    ...
    <div class="container">
      ...
      <div class="main__langs btn-group">
        <nuxt-link
          ...
          :class="['btn-main-local', {'is-active': $store.state.i18n.locale === 'ua'}]"
        >UA</nuxt-link>
        <nuxt-link
          :to="switchLocalePath('ru')"
          :class="['btn-main-local', {'is-active': $store.state.i18n.locale === 'ru'}]"
        >RU</nuxt-link>
        <nuxt-link
          :to="switchLocalePath('en')"
          :class="['btn-main-local', {'is-active': $store.state.i18n.locale === 'en'}]"
        >EN</nuxt-link>
      </div>
    </div>
  </section>
